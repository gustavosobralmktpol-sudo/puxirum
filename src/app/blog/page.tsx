          ...
          <div className="space-y-6">
            {artigos.map((artigo) => (
              <Link
                ...
                className="group block bg-white rounded-2xl border border-primary/[0.06] shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-0.5 overflow-hidden"
              >
                <div className="p-6 md:p-8">
                  ...
                  <h2 className="font-heading font-bold text-primary text-lg md:text-xl mb-3 group-hover:text-accent transition-colors">
                    {artigo.titulo}
                  </h2>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-accent text-sm font-heading font-semibold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                      Ler
