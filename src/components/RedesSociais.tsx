...
const SOCIAL_LINKS = [
  {
    name: "Instagram",
    href: "#", // TROQUE: adicione o link real do Instagram
  ...
  {
    name: "Facebook",
    href: "#", // TROQUE: adicione o link real do Facebook
  ...
  {
    name: "TikTok",
    href: "#", // TROQUE: adicione o link real do TikTok
  ...
  {
    name: "YouTube",
    href: "#", // TROQUE: adicione o link real do YouTube
  ...
  {
    name: "WhatsApp",
    href: "#", // TROQUE: adicione o link real do WhatsApp
  ...
  {
    name: "X / Twitter",
    href: "#", // TROQUE: adicione o link real do X/Twitter
