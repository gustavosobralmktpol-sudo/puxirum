    ...
    <footer className="relative bg-primary-dark text-white/55 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-5 pt-14 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-white/80 font-heading font-semibold text-sm uppercase tracking-wider mb-5">
              Navegação
            </h4>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4 text-white/40">
              Acompanhe o trabalho nas redes sociais.
            </p>
            <div className="flex items-center gap-2 flex-wrap">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 hover:border-white/15 hover:scale-110 transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <a
              href="#formulario"
              className="inline-flex items-center gap-2 bg-accent hover:bg-accent-light text-white text-sm font-heading font-bold px-4 py-2 rounded-full transition-all duration-300 group"
            >
              Registrar demanda
